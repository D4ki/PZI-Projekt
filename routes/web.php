...
Route::get('/tags', [JobController::class, 'allTags']);
Route::get('/jobs/createTag', [JobController::class, 'createTag'])->middleware('auth');


Route::view('/pametniImport', 'pametniImport');
